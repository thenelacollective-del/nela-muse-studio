...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 py-5 px-6 lg:px-12 flex items-center justify-between bg-gradient-to-b from-foreground/30 to-transparent">
      <Link to="/" className="font-serif text-lg text-primary-foreground tracking-wide">
        The Nela Collective
      </Link>
      <div className="hidden md:flex items-center gap-8">
        ...
        <Link to="/founders" className="font-sans text-xs tracking-[0.2em] uppercase text-primary-foreground/70 hover:text-primary-foreground transition-colors">
          Founders
        </Link>
